                                ...
                                <div class="shows-content h-100">
                                    <div class="row align-items-center h-100" >
                                        ...
                                        <div class=" col-lg-5 col-md-12 trailor-video text-center d-none d-lg-block">
                                            <a href="{{ asset('storage') . '/' . $l_serial->trailer }}" class="video-open playbtn">
                    ...
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="main-title ">TV Rated Shows</h4>
                                <a href="{{ route('serial.viewAll', ['type' => 'top_serial']) }}" class="text-primary iq-view-all">View All</a>
                            </div>
                        </div>
                    </div>
                    <!-- Swiper -->
                    <div class="favourite-slider">
                        <div  class="swiper pt-2 pt-md-4 pt-lg-4 iq-rtl-direction " data-swiper="common-slider">
                            <ul class="swiper-wrapper m-0 p-0">
                                @foreach( $top_serials as $t_serial )
                                    <li class="swiper-slide slide-item">
                                        <div class="block-images position-relative ">
                                            <div class="img-box">
                                                <img src="{{ asset('storage') . '/' . $t_serial->image }}" style="height: 185px; width: 100%" class="img-fluid" alt="" loading="lazy">
                                            </div>
                                            <div class="block-description">
                                                <h6 class="iq-title">
                                                    <a href="{{ route('serial.show', ['slug' => $t_serial->slug]) }}">
                                                        {{ $t_serial->name }}
                                                    </a>
                                                </h6>
                                                <div class="hover-buttons">
                                                    <a href="{{ route('serial.show', ['slug' => $t_serial->slug]) }}" role="button" class="btn btn-hover"><i
                                            ...
                                            <div class="block-social-info">
                                                <ul class="list-inline p-0 m-0 music-play-lists">
                                                    ...
                                                    @if( in_array($t_serial->id, $like_exists) )
                                                        <li class="delete_like" data-id="{{ $t_serial->id }}">
                                                            <span style="color: #FFF; background-color: #E50914 ">
                                                                <i class="ri-heart-fill"></i>
                                                            </span>
                                                        </li>
                                                    @else
                                                        <li class="add_like" data-id="{{ $t_serial->id }}">
                                                            <span>
                                                                <i class="ri-heart-fill"></i>
                                                            </span>
                                                        </li>
                                                    @endif
                                                    @if( in_array($t_serial->id, $playlist_exists ) )
                                                        <li class="delete_playlist" data-id="{{ $t_serial->id }}">
                                                            <span href="#" style="background-color: #E50914; color: #fff">
                                                                <i class="fa fa-check"></i>
                                                            </span>
                                                        </li>
                                                    @else
                                                        <li class="add_playlist" data-id="{{ $t_serial->id }}">
                                                            <span href="#" >
