            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('movie.viewAll', ['type' => 'top_movie']) }}" class="text-primary iq-view-all">View All</a>
                    </div>
                </div>
            </div>
            <!-- Swiper -->
            <div class="favourite-slider">
                <div class="swiper pt-2 pt-md-4 pt-lg-4 iq-rtl-direction" data-swiper="common-slider">
                    <ul class="swiper-wrapper m-0 p-0">
                        @foreach( $top_movies as $t_movie )
                            <li class="swiper-slide slide-item">
                                <div class="block-images position-relative ">
                                    <div class="img-box">
                                        <img src="{{ asset('storage') . '/' . $t_movie->image }}" style="height: 185px; width: 100%" class="img-fluid" alt="">
                                    </div>
                                    <div class="block-description">
                                        <h6 class="iq-title">
                                            <a href="{{ route('movie.show', ['slug' => $t_movie->slug]) }}">
                                                {{ $t_movie->name }}
                                            </a>
                                        </h6>
                                        <div class="movie-time d-flex align-items-center my-2">
                                            <span class="text-white">{{ $t_movie->hour }}hr : {{ $t_movie->minute }}mins</span>
                                        </div>
                                        <div class="hover-buttons">
                                            <a href="{{ route('movie.show', ['slug' => $t_movie->slug]) }}" role="button" class="btn btn-hover"><i
                                    ...
                                    <div class="block-social-info">
                                        <ul class="list-inline p-0 m-0 music-play-lists">
                                            ...
                                            @if( in_array($t_movie->id, $like_exists) )
                                                <li class="delete_like" data-id="{{ $t_movie->id }}">
                                                    <span style="color: #FFF; background-color: #E50914 ">
                                                        <i class="ri-heart-fill"></i>
                                                    </span>
                                                </li>
                                            @else
                                                <li class="add_like" data-id="{{ $t_movie->id }}">
                                                    <span>
                                                        <i class="ri-heart-fill"></i>
                                                    </span>
                                                </li>
                                            @endif
                                            @if( in_array($t_movie->id, $playlist_exists ) )
                                                <li class="delete_playlist" data-id="{{ $t_movie->id }}">
                                                    <span href="#" style="background-color: #E50914; color: #fff">
                                                        <i class="fa fa-check"></i>
                                                    </span>
                                                </li>
                                            @else
                                                <li class="add_playlist" data-id="{{ $t_movie->id }}">
                                                    <span href="#" >
