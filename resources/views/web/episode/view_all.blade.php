                ...
                @foreach( $data as $episode )
                    <li class="slide-item col-lg-3 mb-4">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="{{ asset('storage') . '/' . $episode->image }}" class="img-fluid" alt=""
                                     loading="lazy">
                            </div>
                            ...
                            <div class="block-social-info">
                                <ul class="list-inline p-0 m-0 music-play-lists">
                                    <li class="share">
                                        ...
                                        <div class="share-box">
                                            <div class="d-flex align-items-center">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ url('episodes') . '/' . $episode->slug }}"
                                                   class="share-ico">
                                                    <i class="ri-facebook-fill"></i>
                                                </a>
                                                <a href="https://twitter.com/intent/tweet?text=Watch+This+Movie&url={{ url('episodes') . '/' . $episode->slug }}"
                                                   class="share-ico">
                                                    <i class="ri-twitter-fill"></i>
                                                </a>
                                                <a href="https://pinterest.com/pin/create/button/?url={{ url('episodes') . '/' . $episode->slug }}"
                                                   class="share-ico">
                                    ...
                                    @if( in_array($episode->id, $like_exists) )
                                        <li class="delete_like" data-id="{{ $episode->id }}">
                                            <span style="color: #FFF; background-color: #E50914 ">
                                                <i class="ri-heart-fill"></i>
                                            </span>
                                        </li>
                                    @else
                                        <li class="add_like" data-id="{{ $episode->id }}">
                                            <span>
                                                <i class="ri-heart-fill"></i>
                                            </span>
                                        </li>
                                    @endif
                                    @if( in_array($episode->id, $playlist_exists) )
                                        {{-- Here Will Be Delete --}}
                                        <li class="delete_playlist" data-id="{{ $episode->id }}">
                                    ...
                                    @else
                                        {{-- Here Will Be Add --}}
                                        <li class="add_playlist" data-id="{{ $episode->id }}">
                                            <span href="#">
