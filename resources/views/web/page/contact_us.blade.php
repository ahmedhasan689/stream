        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div class="row contact-detail justify-content-center text-center">
                        <div class="col-md-4">
                            <div class="iq-contact-list" data-element_type="column" style="border-right: 0.063em solid">
                                <div class="icon-box">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Capa_3" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                ...
                                <div class="icon-box-content">
                                    ...
                                    <a href="mailto:name@email.com" class="icon-box-description">support@streamit.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
