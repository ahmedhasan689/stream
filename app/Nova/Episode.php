...
class Episode extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            File::make('video')->updateRules('nullable')->creationRules('required')->path('episodeVideo'),
            File::make('trailer')->updateRules('nullable')->creationRules('required')->path('episodeTrailer'),
